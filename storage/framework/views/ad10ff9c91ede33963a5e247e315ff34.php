...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Rollen Beheer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Rollen Beheer')]); ?>
        <main class="p-6">
            <header class="mb-6">
            ...
            <div class="flex gap-3 mb-6">
                ...
                <div class="ml-auto">
                    <a href="<?php echo e(route('management.users.index')); ?>" class="px-4 py-2 border border-indigo-600 text-indigo-600 rounded hover:bg-indigo-50 font-medium text-sm">
                        👥 Bekijk Werknemers
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\Users\PowerHouse V2\Herd\Barocc-intens\resources\views/management/roles/index.blade.php ENDPATH**/ ?>