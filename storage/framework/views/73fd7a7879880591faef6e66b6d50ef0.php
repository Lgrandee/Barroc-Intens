...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-header','data' => ['title' => __('Login to your account'),'description' => __('Enter your email and password below to login')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Login to your account')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Enter your email and password below to login'))]); ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if(Route::has('register')): ?>
        <div class="space-x-1 text-sm text-center rtl:space-x-reverse text-zinc-600 text-zinc-400">
            <span><?php echo e(__('Don\'t have an account? Ask the administrator to create one.')); ?></span>
        </div>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH C:\Users\PowerHouse V2\Herd\Barocc-intens\resources\views\livewire/auth/login.blade.php ENDPATH**/ ?>